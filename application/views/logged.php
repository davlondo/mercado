...
<head>
    ...
    <title>Administrador Banreservas</title>
...
<body>
    ...
    <script src="<?php echo base_url().'sources/vendor/raphael/raphael.min.js'?>"></script>
    <script src="<?php echo base_url().'sources/vendor/morrisjs/morris.min.js'?>"></script>
    <script src="<?php echo base_url().'sources/data/morris-data.js'?>"></script>
